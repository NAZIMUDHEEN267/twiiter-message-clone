...
function Emoji(options) {
  ...
  this.lib = function () {
    const _el = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;

    const isNodeList = function isNodeList(nodes) {
    ...
    return {
      el: function el() {
        ...
        if (isNodeList(_el)) {
          return Array.from(_el);
        }

        if (typeof _el === 'string' || typeof _el === 'STRING') {
          return Array.from(document.querySelectorAll(_el));
        }

        return undefined;
      },
      on: function on(event, callback) {
        const classList = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
      ...
      css: function css(params) {
        ...
        const _loop = function _loop(key) {
          if (Object.hasOwnProperty.call(params, key)) {
            ...
            _this.el().forEach((el) => el.style[key] = cssVal);
          }
        };
      ...
      attr: function attr(param1) {
        const param2 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
      ...
      removeAttr: function removeAttr(param) {
        this.el().forEach((el) => el.removeAttribute(param));
      },
      addClass: function addClass(param) {
        this.el().forEach((el) => el.classList.add(param));
      },
      removeClass: function removeClass(param) {
        this.el().forEach((el) => el.classList.remove(param));
      },
      slug: function slug(str) {
        return str.toLowerCase().replace(/[^\u00BF-\u1FFF\u2C00-\uD7FF\w]+|[\_]+/ig, '-').replace(/ +/g, '-');
      },
      remove: function remove(param) {
        this.el().forEach((el) => el.remove());
      },
      val: function val() {
        const param = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;
        let val;
      ...
      text: function text() {
        const msg = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;
      ...
      html: function html() {
        const data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;
  ...
  var functions = {
    ...
    rePositioning: function rePositioning(picker) {
      picker.getBoundingClientRect().right > window.screen.availWidth ? picker.style.left = ''.concat(window.screen.availWidth - picker.offsetWidth, 'px') : false;

      if (window.innerHeight > pickerHeight) {
        picker.getBoundingClientRect().bottom > window.innerHeight ? picker.style.top = ''.concat(window.innerHeight - picker.offsetHeight, 'px') : false;
      }
    },
    render: function render(e, attr) {
      emojiList = undefined;

      const index = _this2.options.trigger.findIndex((item) => item.selector === attr);

      _this2.insertInto = _this2.options.trigger[index].insertInto;
      ...
      if (!emojiesHTML.length) {
        for (const key in emojiObj) {
          if (emojiObj.hasOwnProperty.call(emojiObj, key)) {
            ...
            categoriesHTML += '<li>\n                            <a title="'.concat(key, '" href="#').concat(key, '">').concat(categoryFlags[key], '</a>\n                        </li>');
            emojiesHTML += '<div class="fg-emoji-picker-category-wrapper" id="'.concat(key, '">');
            emojiesHTML += '<p class="fg-emoji-picker-category-title">'.concat(key, '</p>');
            categoryObj.forEach((ej) => {
              emojiesHTML += '<li data-title="'.concat(ej.title.toLowerCase(), '">\n                                    <a title="').concat(ej.title, '" href="#">').concat(ej.emoji, '</a>\n                                </li>');
            });
            emojiesHTML += '</div>';
          }
        }
      ...
      if (document.querySelector('.fg-emoji-container')) {
        _this2.lib('.fg-emoji-container').remove();
      }

      const picker = '\n                <div class="fg-emoji-container" style="left: '.concat(position.left, 'px; top: ').concat(position.top, 'px;">\n                    <nav class="fg-emoji-nav">\n                        <ul>\n                            ').concat(categoriesHTML, '\n\n                            ').concat(_this2.options.closeButton ? '<li class="fg-picker-special-buttons"><a id="fg-emoji-picker-close-button" href="#">'.concat(icons.close, '</a></li>') : '', '\n                        </ul>\n                    </nav>\n\n                    <div class="fg-emoji-picker-search">\n                        <input type="text" placeholder="Search" autofocus />\n                        \n                        <span class="fg-emoji-picker-search-icon">')
        .concat(icons.search, '</sapn>\n                    </div>\n\n                    <div>\n                        <!--<div class="fg-emoji-picker-loader-animation">\n                            <div class="spinner">\n                                <div class="bounce1"></div>\n                                <div class="bounce2"></div>\n                                <div class="bounce3"></div>\n                            </div>\n                        </div>-->\n\n                        <ul class="fg-emoji-list">\n                            ')
    ...
    setCaretPosition: function setCaretPosition(field, caretPos) {
      const elem = field;
    ...
    insert: function insert(e) {
      ...
      const myField = document.querySelectorAll(_this2.insertInto);
      const myValue = emoji; // Check if selector is an array
    ...
    categoryNav: function categoryNav(e) {
      ...
      const destination = emojiBody.querySelector(''.concat(id));

      _this2.lib('.fg-emoji-nav li').removeClass('emoji-picker-nav-active');
    ...
    mouseMove: function mouseMove(e) {
      if (moseMove) {
        ...
        el.style.left = ''.concat(e.clientX - 320, 'px');
        el.style.top = ''.concat(e.clientY - 10, 'px');
      }
    },
  };

  const bindEvents = function bindEvents() {
    _this2.lib(document.body).on('click', functions.closePicker, '#fg-emoji-picker-close-button');

    _this2.lib(document.body).on('click', functions.checkPickerExist);

    _this2.lib(document.body).on('click', functions.render, _this2.trigger);

    _this2.lib(document.body).on('click', functions.insert, '.fg-emoji-list a');

    _this2.lib(document.body).on('click', functions.categoryNav, '.fg-emoji-nav a');

    _this2.lib(document.body).on('input', functions.search, '.fg-emoji-picker-search input');

    _this2.lib(document).on('mousedown', functions.mouseDown, '#fg-emoji-picker-move');

    _this2.lib(document).on('mouseup', functions.mouseUp, '#fg-emoji-picker-move');

    _this2.lib(document).on('mousemove', functions.mouseMove);
  };

  (function () {
    // Start styles
    functions.styles(); // Event functions
